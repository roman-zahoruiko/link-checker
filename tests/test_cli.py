...
class TestLinkCheckerCli(unittest.TestCase):
    ...
    def test_cases_cli(self):
        cases = [
            ...
            ('//python.org/', [(False, 'the website redirects to https://www.python.org/ location'),
                               (False, 'the website rejects robots'),
                               (True, 'the website is not parked')]),
            ('python.org/some/path/', [(False, 'the website redirects to https://www.python.org/ location'),
                                       (False, 'the website rejects robots'),
                                       (True, 'the website is not parked')]),
            ('https://www.python.org/', [(True, 'the website valid as is'),
                                         (False, 'the website rejects robots'),
                                         (True, 'the website is not parked')]),
            ('https://www.python.org/broken/path ', [(True, 'the website valid as is'),
                                                     (False, 'the website rejects robots'),
                                                     (True, 'the website is not parked')]),
            ('http://conversationgrabber.com', [(True, 'the website valid as is'),
                                                (False, 'the website rejects robots'),
                                                (False, 'the website is probably parked')]),
            ]
