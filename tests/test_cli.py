    ...
    def test_cases_cli(self):
        cases = [
            ...
            ('//konstankino.com', [(True, 'the website redirects to https'),
                                   ...
                                   (True, 'the website is not parked')]),
            ('konstankino.com/some', [(True, 'the website redirects to https'),
                                      (True, 'the website accepts robots'),
                                      (True, 'the website is not parked')]),
            ('konstankino.com/some/path/', [(True, 'the website redirects to https'),
                                            (True, 'the website accepts robots'),
                                            (True, 'the website is not parked')]),
            ('https://konstankino.com/broken/path ', [(True, 'the website valid as is'),
                                                      (True, 'the website accepts robots'),
                                                      (True, 'the website is not parked')]),
